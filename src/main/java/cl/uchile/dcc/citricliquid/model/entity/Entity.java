...
public class Entity {
    ...
    /**
     * <i>isAlive</i> <br>
     * true if the enetity is alive, false otherwise.
     */
    ...
    /**
     * <b>Combat!</b> <br>
     * The idea behind is that is modeled from the view of the defender
     * since the attacker always attacks. <br> <br>
     * <i>defend</i> <br>
     * defends from the attack from another entity. returns if the entity is still alive.
     */

    public boolean defend (Entity entity) {
        setHp(hp - Math.max(1, attack(entity) - (def + this.roll())));
        return isAlive();
    }
     ...
     */
    public boolean evade (Entity entity) {
        int dmg = attack(entity);
        if ( this.evd + this.roll() <= dmg){
            setHp(hp - dmg);
        }
        return isAlive();
    }
    ...
    /**
     * <i>attack</i> <br>
     * Gives you the amount of potential damage of an entity
     */
    public int attack(Entity entity) {
        return entity.roll() + entity.getAtk();
    }
