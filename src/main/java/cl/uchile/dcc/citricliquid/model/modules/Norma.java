...
public class Norma {
  ...
  public boolean check() throws IllegalArgumentException, IllegalStateException {
    ...
    switch (this.goal) {
      ...
      case STARS:
        switch (this.level){
          case 2:
            return this.stars >= 30;
          case 3:
            return this.stars >= 70;
          case 4:
            return this.stars >= 120;
          case 5:
            return this.stars >= 200;
          default: // Something terribly wrong happened.
            throw new IllegalStateException("Norma level is out of bounds");
        }
      default:
        throw new IllegalStateException("Unknown norma goal: " + this.goal);
    }
  }
   ...
   */
  public void substractStars(int quantity) {
    if (quantity < 0) throw new IllegalArgumentException("Quantity must be positive: " + quantity);
  ...
  public boolean equals(Object o) {
    if (!(o instanceof Norma n)) return false;
